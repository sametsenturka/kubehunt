...
const (
	...
	CapabilityServicesList                        CapabilityID = "kubernetes.networking.services.list"
	CapabilityIngressesList                       CapabilityID = "kubernetes.networking.ingresses.list"
	CapabilityNetworkPoliciesList                 CapabilityID = "kubernetes.networking.networkpolicies.list"
	CapabilityClusterEndpointObserve              CapabilityID = "kubernetes.cluster.endpoint.observe"
